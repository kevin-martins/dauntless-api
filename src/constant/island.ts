import { IslandDto } from "src/island/dto";
    ...
    events: [
      {
        name: "Aether Surge",
        description:
          "Aether surges are a common occurrence across the Hunting Grounds, attracting powerful Behemoths and other hostile creatures.",
      },
    ],
    discoveries: [
      {
